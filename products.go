...
type Product struct {
	...
	DeliveryInStock         *string              `xml:"delivery_in_stock,omitempty" json:"delivery_in_stock,omitempty"`
	DeliveryOutStock        *string              `xml:"delivery_out_stock,omitempty" json:"delivery_out_stock,omitempty"`
	...
	MetaDescription         *string              `xml:"meta_description,omitempty" json:"meta_description,omitempty"`
	MetaKeywords            *string              `xml:"meta_keywords,omitempty" json:"meta_keywords,omitempty"`
	MetaTitle               *string              `xml:"meta_title,omitempty" json:"meta_title,omitempty"`
	LinkRewrite             *string              `xml:"link_rewrite,omitempty" json:"link_rewrite,omitempty"`
	Name                    *string              `xml:"name,omitempty" json:"name,omitempty"`
	Description             *string              `xml:"description,omitempty" json:"description,omitempty"`
	DescriptionShort        *string              `xml:"description_short,omitempty" json:"description_short,omitempty"`
	AvailableNow            *string              `xml:"available_now,omitempty" json:"available_now,omitempty"`
	AvailableLater          *string              `xml:"available_later,omitempty" json:"available_later,omitempty"`
